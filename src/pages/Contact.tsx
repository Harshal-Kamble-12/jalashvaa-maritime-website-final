...
const Contact = () => {
  ...
  const [crewForm, setCrewForm] = useState<CrewFormData>({
    name: "",
    email: "",
    phone: "",
    rank: "",
  ...
  const [crewErrors, setCrewErrors] = useState<CrewFormErrors>({});
  ...
  const validateCrew = (): boolean => {
    const errs: CrewFormErrors = {};

    if (!crewForm.name.trim()) errs.name = "Name is required.";

    if (!crewForm.email.trim()) errs.email = "Email is required.";
    else if (!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(crewForm.email))
      errs.email = "Enter a valid email.";

    if (!crewForm.rank.trim()) errs.rank = "Rank is required.";

    if (!crewForm.message.trim()) errs.message = "Message is required.";
  ...
  const handleCrewSubmit = (e: FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    ...
    emailjs
      ...
      .catch(() => {
        alert("Failed to submit crew application.");
      });
  };
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      508-509,A-wing,Mahavir Icon, Plot 89/90, Sector 15,
              ...
              <div className="bg-card rounded-lg p-8 shadow-maritime">
                ...
                {submitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <button className="w-full bg-navy text-white py-3 rounded flex items-center justify-center gap-2">
              ...
              <div className="bg-card rounded-lg p-8 shadow-maritime">
                ...
                {crewSubmitted ? (
                  ...
                  <form onSubmit={handleCrewSubmit} className="space-y-5">
                    ...
                    <input
                      type="text"
                      placeholder="Rank (Chief Officer, Engineer etc)"
                      value={crewForm.rank}
                      onChange={(e) =>
                        setCrewForm({ ...crewForm, rank: e.target.value })
                      }
                      className="w-full px-4 py-2 border rounded"
                    />
                    ...
                    <textarea
                      rows={4}
                      placeholder="Message"
                      value={crewForm.message}
                      onChange={(e) =>
                        setCrewForm({ ...crewForm, message: e.target.value })
                      }
                      className="w-full px-4 py-2 border rounded"
                    />

                    <button className="w-full bg-navy text-white py-3 rounded">
                      Submit Application
                    </button>
